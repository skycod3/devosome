    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 48 }}>
          <div
            style={{ width: 20, height: 20, borderRadius: 999, background: "#ff5f57" }}
          />
          <div
            style={{ width: 20, height: 20, borderRadius: 999, background: "#febc2e" }}
          />
          <div
            style={{ width: 20, height: 20, borderRadius: 999, background: "#28c840" }}
          />
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center" }}>
          ...
          <div style={{ color: "#f8fafc", fontSize: 80, fontWeight: 700, lineHeight: 1.05 }}>
            {ABOUT_ME.name}
          </div>
